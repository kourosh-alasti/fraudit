...
exports.log = (content, type = 'log') => {
    ...
    switch (type) {
        ...
        default: throw new TypeError("Logger must be either warn, debug, log, ready, cmd, or error")
    }
}

exports.error= (...args) => this.log(...args, 'warn')
exports.warn= (...args) => this.log(...args, 'error')
